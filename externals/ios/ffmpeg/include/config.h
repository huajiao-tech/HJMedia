...
#define FFMPEG_CONFIGURATION "--prefix=/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/outs_ios --arch=arm64 --target-os=darwin --cc=clang --enable-cross-compile --enable-runtime-cpudetect --enable-static --disable-shared --enable-pic --enable-gpl --enable-version3 --enable-small --enable-asm --disable-doc --disable-debug --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-postproc --disable-vulkan --disable-hwaccels --disable-cuda-llvm --disable-cuvid --disable-encoders --enable-encoder=flv --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=png --enable-libx264 --enable-encoder=libx264 --disable-decoders --enable-decoder=mpeg4 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=flv --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=png --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer=hls --enable-muxer=flv --disable-demuxers --enable-demuxer=hls --enable-demuxer=mpegts --enable-demuxer=mov --enable-demuxer=flv --enable-demuxer=live_flv --enable-demuxer=rtsp --enable-demuxer=mp3 --enable-demuxer=matroska --enable-demuxer=gif --enable-demuxer=aac --enable-hwaccel=h264_videotoolbox --enable-hwaccel=hevc_videotoolbox --enable-openssl --pkg-config-flags=--static --install_name_dir='@rpath' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk --extra-cflags='-iwithsysroot /usr/include/libxml2 -arch arm64 -miphoneos-version-min=9.0 -I/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/deps/isys/openssl/include -I/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/deps/isys/x264/include' --extra-ldflags='-arch arm64 -miphoneos-version-min=9.0 -Wl,-dead_strip -L/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/deps/isys/openssl/lib -L/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/deps/isys/x264/lib' --extra-libs='-lssl -lcrypto -lx264'"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/outs_ios/share/ffmpeg"
#define AVCONV_DATADIR "/Users/zhiyongleng/works/FFmpeg/proj701/ffmpeg/outs_ios/share/ffmpeg"
