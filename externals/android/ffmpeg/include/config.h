...
#define FFMPEG_CONFIGURATION "--tempprefix=/Users/lfs/code/git/ffmpeg/ffmpeg/build_aos/tmp/ffconf --pkg-config=/opt/homebrew/bin/pkg-config --prefix=/Users/lfs/code/git/ffmpeg/ffmpeg/build_aos/arm64-v8a --cross-prefix=/Users/lfs/tool/android/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/llvm- --target-os=android --arch=aarch64 --cpu=armv8-a --cc=/Users/lfs/tool/android/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang --cxx=/Users/lfs/tool/android/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang++ --nm=/Users/lfs/tool/android/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/llvm-nm --strip=/Users/lfs/tool/android/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/bin/llvm-strip --enable-cross-compile --sysroot=/Users/lfs/tool/android/ndk/25.1.8937393/toolchains/llvm/prebuilt/darwin-x86_64/sysroot --extra-cflags=-I/Users/lfs/code/git/ffmpeg/ffmpeg/deps/asys/openssl/include --extra-ldflags=-L/Users/lfs/code/git/ffmpeg/ffmpeg/deps/asys/openssl/lib --extra-libs='-lssl -lcrypto' --extra-ldexeflags=-pie --enable-runtime-cpudetect --enable-static --disable-shared --disable-ffmpeg --disable-ffplay --disable-ffprobe --enable-avfilter --enable-filters --enable-small --disable-armv5te --disable-armv6 --disable-armv6t2 --enable-vfp --enable-neon --enable-pic --disable-gpl --enable-version3 --enable-asm --disable-x86asm --disable-debug --enable-avdevice --enable-jni --enable-mediacodec --disable-hwaccels --disable-encoders --enable-encoder=flv --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=png --disable-libx264 --disable-encoder=libx264 --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=flv --disable-decoders --enable-decoder=mpeg4 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=flv --enable-decoder=aac --enable-decoder=aac_mediacodec --enable-decoder=ac3 --enable-decoder=h264_mediacodec --enable-decoder=hevc_mediacodec --enable-decoder=mp3 --enable-decoder=mp3_mediacodec --enable-decoder=mpeg4_mediacodec --enable-decoder=opus --disable-demuxers --enable-demuxer=hls --enable-demuxer=mpegts --enable-demuxer=mov --enable-demuxer=flv --enable-demuxer=live_flv --enable-demuxer=rtsp --enable-demuxer=mp3 --enable-demuxer=matroska --enable-demuxer=gif --enable-demuxer=aac --enable-openssl --pkg-config-flags=--static"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/Users/lfs/code/git/ffmpeg/ffmpeg/build_aos/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/lfs/code/git/ffmpeg/ffmpeg/build_aos/arm64-v8a/share/ffmpeg"
