...
//CS by lzy
void ARGBToYRow_NEON_BT709(const uint8_t* src_argb, uint8_t* dst_y, int width);
...
void ARGBToUVRow_NEON(const uint8_t* src_argb,
                      ...
                      int width);
//CS by lzy
void ARGBToUVRow_NEON_BT709(const uint8_t* src_argb,
                      int src_stride_argb,
                      uint8_t* dst_u,
                      uint8_t* dst_v,
                      int width);
...
//CS by lzy
void ARGBToYRow_C_BT709(const uint8_t* src_rgb, uint8_t* dst_y, int width);
...
//CS by lzy
void ARGBToYRow_Any_NEON_BT709(const uint8_t* src_ptr, uint8_t* dst_ptr, int width);
...
void ARGBToUVRow_Any_NEON(const uint8_t* src_ptr,
                          ...
                          int width);
//CS by lzy
void ARGBToUVRow_Any_NEON_BT709(const uint8_t* src_ptr,
                          int src_stride,
                          uint8_t* dst_u,
                          uint8_t* dst_v,
                          int width);
...
void ARGBToUVRow_C(const uint8_t* src_rgb,
                   ...
                   int width);
//CS by lzy
void ARGBToUVRow_C_BT709(const uint8_t* src_rgb,
                   int src_stride_rgb,
                   uint8_t* dst_u,
                   uint8_t* dst_v,
                   int width);
