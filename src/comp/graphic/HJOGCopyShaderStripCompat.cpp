...
HJOGCopyShaderStripCompat::HJOGCopyShaderStripCompat()
{
    HJ_SetInsName(HJOGCopyShaderStripCompat);
}
HJOGCopyShaderStripCompat::~HJOGCopyShaderStripCompat()
{
}

int HJOGCopyShaderStripCompat::init(int i_nFlag, bool i_bPreMultipleShader)
{
    int i_err = 0;
    do
    {
...
int HJOGCopyShaderStripCompat::draw(GLuint textureId, float *vertexMat, float *texMat)
{
int i_err = 0;
    do
    {
...
int HJOGCopyShaderStripCompat::draw(GLuint textureId, int i_mode, int srcw, int srch, int dstw, int dsth, float *texMat, bool i_bYFlip, bool i_bXFlip)
{
    int i_err = 0;
    do
    {
...
void HJOGCopyShaderStripCompat::release()
{
    if (m_shaderProgram)
    {
