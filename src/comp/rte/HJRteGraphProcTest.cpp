...
int HJRteGraphProcTest::constructGraph(HJBaseParam::Ptr i_param)
{
    int i_err = HJ_OK;
    do
    {
		...
		connectCom(videoSource, blur);
		connectCom(blur, uicom, shader2D, HJRteComLinkInfo::Create<HJRteComLinkInfo>(0,0,1,1, HJWindowRenderMode_FIT));
		...
		//connectCom(faceu, uicom, shaderNoPreMul2D, HJRteComLinkInfo::Create<HJRteComLinkInfo>(0, 0, 1, 1, HJWindowRenderMode_FIT));
		connectCom(faceu, blur);
		//connectCom(blur, uicom, shader2D, HJRteComLinkInfo::Create<HJRteComLinkInfo>(0, 0, 1, 1, HJWindowRenderMode_FIT));
		...
		connectCom(customFilter, detectPBO, shader2D);
