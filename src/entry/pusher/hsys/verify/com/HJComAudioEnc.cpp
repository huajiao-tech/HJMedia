...
HJComAudioEnc::HJComAudioEnc()
{
    HJ_SetInsName(HJComAudioEnc);  
...
int HJComAudioEnc::init(HJBaseParam::Ptr i_param)
{
    int i_err = 0;
    do 
    {
...
int HJComAudioEnc::doSend(HJComMediaFrame::Ptr i_frame)
{
    int i_err = 0;
    do 
    {
