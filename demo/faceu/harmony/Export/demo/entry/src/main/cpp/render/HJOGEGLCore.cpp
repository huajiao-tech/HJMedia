...
//}
int HJOGEGLCore::makeCurrent()
{
    return makeCurrent(m_eglSurface);
}
int HJOGEGLCore::swap()
{
    return swap(m_eglSurface);
}
int HJOGEGLCore::makeCurrent(EGLSurface i_surface)
{
    ...
    do
    {
        //HJFLogi("{} makeCurrent: enter surface:{}", m_insName, size_t(i_surface));         
        if (m_eglDisplay == EGL_NO_DISPLAY)
        {
            i_err = -1;
        ...
        //HJFLogi("{} makeCurrent: SUCCESS surface:{}", m_insName, size_t(i_surface));
    } while (false);
    return i_err;
}
int HJOGEGLCore::swap(EGLSurface i_surface)
{
    ...
    {         
        ...
        //HJFLogi("{} swapBuffers: SUCCESS surface:{}", m_insName, size_t(i_surface));
    } while (false);
    return i_err;
}
...
EGLSurface HJOGEGLCore::EGLSurfaceCreate(void *window)
{
    ...
    do
    {
        ...
        HJFLogi("{} EGLSurfaceCreate: SUCCESS:{}", m_insName, size_t(eglSurface));
    } while (false);
    return eglSurface;
}
...
int HJOGEGLCore::EGLOffScreenSurfaceCreate(int width, int height)
{
    ...
    do
    {
         if (m_eglDisplay != EGL_NO_DISPLAY)
         {
            ...
            HJFLogi("{} EGLOffScreenSurfaceCreate: SUCCESS:{}", m_insName, size_t(m_eglOffScreenSurface));
        }
    } while (false);
    return i_err;
}
...
{     
    if (m_eglDisplay != EGL_NO_DISPLAY)
    {
        ...
        {
            EGLSurfaceRelease(m_eglSurface);    
