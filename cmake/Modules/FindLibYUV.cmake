...
set(PROJ_LIB_NAME yuv)
set(PROJ_DIR_NAME libyuv)
set(PROJ_HEADER libyuv.h)

if("${PLATFORM_DIR}" STREQUAL "mac")
  set(YUV_INCLUDE_SUFFIX include/${ARCHS_NAME})
else()
  set(YUV_INCLUDE_SUFFIX include)
endif()
...
find_path(
  ...
  PATH_SUFFIXES ${YUV_INCLUDE_SUFFIX})
