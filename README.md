...
| 信息统计                 | 统计推流状态及网络状态                           | Y    |                                                                             |
| 日志分析                 | 支持控制台日志及文件日志循环记录                      | Y    | 便于问题定位及异常分
| 萌颜功能                 | 支持采集端支持萌颜，根据人脸运动贴纸动态跟随变化                      | Y    | 需先将人脸检测模块打开(人脸检测模块已支持)                                                             |
| 人脸保护功能                 | 支持直接间检测在无人直播状态下，画面自动模糊                      | Y    | 需先将人脸检测模块打开(人脸检测模块已支持)   
- 播放器
...
- 工程构建
  ...
  - Windows
    ...
    ![](examples/windows/doc/build_proj.jpg)
